...
import { addHotelDetail } from "../../service/itemApi";
...
function AddHotel() {
  ...
  const addItem = async () => {
    ...
    let response = await addHotelDetail(item);
    if (!response) {
          ...
          <div className="mainContainer">
            ...
            <div className="totalQuantityContainer">
              <Typography style={{ fontSize: "30px", color: "white" }}>
               ...
               <Typography style={{ fontSize: "30px", color: "white" }}>[ {hotels.length} ]</Typography> 
              ...
              <div className="table-body">
                <div className="table">
                {
                  hotels.length?(
                    hotels.map((hotel) => {
                      return (
                        <div className="table-row" key={hotel.itemTitle}>
                        <div className="table-column bank">
                          <div className="">{hotel.itemTitle}</div>
                        </div>
                        <div className="table-column ifsc">
                          <div className="">{hotel.primaryAddress}</div>
                        </div>
                        <div className="table-column branch">
                          <div className="">{hotel.secondaryAddress}</div>
                        </div>
                        <div className="table-column bank-id">
                          <div className="">{hotel.contact}</div>
                        </div>
                    ...
                    <Box sx={{ width: "100%" }}>
                      <Typography>No hotel added</Typography>
                    </Box>
                  </div>
                  )
