...
import { addShoppingMallDetail } from "../../service/itemApi";
...
function AddShoppingMalls() {
  ...
  const addItem = async () => {
    ...
    let response = await addShoppingMallDetail(item);
    if (!response) {
        ...
        <div className="rootContainer">
          ...
          <div className="mainContainer">
            ...
            <div className="totalQuantityContainer">
              <Typography style={{ fontSize: "30px", color: "white" }}>
               Total Shoppingmalls added: 
               </Typography>
               <Typography style={{ fontSize: "30px", color: "white" }}>[ {shoppingmalls.length} ]</Typography> 
              ...
              <div className="table-body">
                <div className="table">
                {
                  shoppingmalls.length?(
                    shoppingmalls.map((shoppingmalls) => {
                      return (
                        <div className="table-row" key={shoppingmalls.itemTitle}>
                        <div className="table-column bank">
                          <div className="">{shoppingmalls.itemTitle}</div>
                        </div>
                        <div className="table-column ifsc">
                          <div className="">{shoppingmalls.primaryAddress}</div>
                        </div>
                        <div className="table-column branch">
                          <div className="">{shoppingmalls.secondaryAddress}</div>
                        </div>
                        <div className="table-column bank-id">
                          <div className="">{shoppingmalls.contact}</div>
                        </div>
                        <div className="table-column address">
                          <a href={shoppingmalls.website}>
                          <div className="">website</div>
                          </a>
                        </div>
                      </div>
                    ...
                    <Box sx={{ width: "100%" }}>
                      <Typography>No shoppingmalls added</Typography>
                    </Box>
                  </div>
                  )
