...
import { addLibraryDetail } from "../../service/itemApi";
...
function AddLibrary() {
  ...
  const addItem = async () => {
    ...
    let response = await addLibraryDetail(item);
    if (!response) {
        ...
        <div className="rootContainer">
          ...
          <div className="mainContainer">
            ...
            <div className="totalQuantityContainer">
              <Typography style={{ fontSize: "30px", color: "white" }}>
               Total Libraries added: 
               </Typography>
               <Typography style={{ fontSize: "30px", color: "white" }}>[ {librarys.length} ]</Typography> 
                ...
                <div className="table">
                {
                  librarys.length?(
                    librarys.map((library) => {
                      return (
                        <div className="table-row" key={library.itemTitle}>
                        <div className="table-column bank">
                          <div className="">{library.itemTitle}</div>
                        </div>
                        <div className="table-column ifsc">
                          <div className="">{library.primaryAddress}</div>
                        </div>
                        <div className="table-column branch">
                          <div className="">{library.secondaryAddress}</div>
                        </div>
                        <div className="table-column bank-id">
                          <div className="">{library.contact}</div>
                        </div>
                    ...
                    <Box sx={{ width: "100%" }}>
                      <Typography>No library added</Typography>
                    </Box>
                  </div>
                  )
