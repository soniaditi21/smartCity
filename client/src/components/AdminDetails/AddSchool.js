...
import { addSchoolDetail } from "../../service/itemApi";
...
function AddSchool() {
  ...
  const addItem = async () => {
    ...
    let response = await addSchoolDetail(item);
    if (!response) {
          ...
          <div className="mainContainer">
            ...
            <div className="totalQuantityContainer">
              <Typography style={{ fontSize: "30px", color: "white" }}>
               ...
               <Typography style={{ fontSize: "30px", color: "white" }}>[ {schools.length} ]</Typography> 
              ...
              <div className="table-body">
                <div className="table">
                {
                  schools.length?(
                    schools.map((school) => {
                      return (
                        <div className="table-row" key={school.itemTitle}>
                        <div className="table-column bank">
                          <div className="">{school.itemTitle}</div>
                        </div>
                        <div className="table-column ifsc">
                          <div className="">{school.primaryAddress}</div>
                        </div>
                        <div className="table-column branch">
                          <div className="">{school.secondaryAddress}</div>
                        </div>
                    ...
                    <Box sx={{ width: "100%" }}>
                      <Typography>No school added</Typography>
                    </Box>
                  </div>
                  )
