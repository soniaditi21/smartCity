            ...
            {temples.map((temple) => (
               ...
               <Grid item xs={12} md={6} >
                ...
                <div className="content">
                  <Typography className='cardName'>{temple.itemTitle}</Typography>
                  <div className="cardImageContainer" >
                    <img className="cardImage" src={temple.image} alt=""/>
                  </div>
                  <div className="details">
                   <Typography>{temple.primaryAddress}</Typography>
                   <Typography>{temple.secondaryAddress}</Typography>

                   <div className="contact-detail">
                   <Typography> <PhoneIcon fontSize='small' /><span >{temple.contact}</span></Typography>
                  <Typography> <LanguageIcon fontSize="small" /><a href={temple.website}><span > Website</span></a></Typography>
                   </div>
